        ...
        <tbody>
            ...
            try {
                ...
                foreach ($clients as $client) {
                    ...
                    echo '<tr onclick="window.location=\'detail_client.php?id=' . $client['id_client'] . '\';" style="cursor:pointer;">';
                    ...
                    echo '<td>' . '<img src="data:image/jpeg;base64,' . base64_encode($client['image_defaut']) . '" alt="Imagewidth="70" height="70">' . '</td>';
                    echo '<td>' . $client['remarque'] . '</td>';
                    echo '<td>';
                    ...
                    echo '<input type="hidden" name="id" value="' . $client['id_client'] . '">';
                    echo '<button type="submit" class="btn btn-danger" onclick="return confirm(\'Voulez-vous vraiment supprimer ce client ?\')">Supprimer</button>';
                    echo '</form>';
